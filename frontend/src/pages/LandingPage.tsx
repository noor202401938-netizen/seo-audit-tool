                ...
                <div className="relative z-10 max-w-container-max mx-auto px-margin-desktop grid grid-cols-1 lg:grid-cols-2 gap-16 items-center pt-32 pb-24">
                    <div className="space-y-stack-md reveal">
                        ...
                        <div className="flex flex-wrap gap-5 pt-6">
                            <Link to="/signup">
                                <button className="group relative flex items-center gap-4 bg-gradient-to-r from-electric-indigo to-cyan-flare text-white pl-8 pr-2 py-2 rounded-full font-headline-md text-headline-md active:scale-95 transition-all shadow-[0_0_20px_rgba(99,102,241,0.3)] hover:shadow-[0_0_40px_rgba(99,102,241,0.5)] btn-shimmer-hover">
