export const TOOL_CATEGORIES = [
    {
        ...
        tools: [
            ...
            { name: "Core Web Vitals Checker", desc: "Measure your site's loading performance and identify speed optimization opportunities. Fast-loading websites rank better and provide superior user experience." },
